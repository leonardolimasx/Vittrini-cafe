      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-md mx-auto bg-stone-50 rounded-2xl overflow-hidden shadow-lg border border-stone-200">
          ...
          <div className="p-6 text-center">
            <h3 className="text-2xl font-semibold text-terracota-700 mb-4">
            ...
            <div className="border-t border-stone-200 pt-3 mt-4">
              ...
              <div className="flex justify-center gap-5 text-sm">
                <div>
                  <span className="font-bold text-stone-700">P:</span> <span className="text-green-700 font-semibold">{cardapio?.preco_marmita_p || '-'}</span>
                </div>
                <div>
                  <span className="font-bold text-stone-700">M:</span> <span className="text-green-700 font-semibold">{cardapio?.preco_marmita_m || '-'}</span>
                </div>
                <div>
                  <span className="font-bold text-stone-700">G:</span> <span className="text-green-700 font-semibold">{cardapio?.preco_marmita_g || '-'}</span>
                </div>
              </div>
            </div>
